...
try {
    ...
    return r.readLine();
          ...
          { id: "l-10-23", title: "Escape Room: The Java Mastery Vault", type: "game-based-learning", duration: "45m", completed: false, locked: false,
            ...
            gameUrl: "https://mission-sim-timespro.lovable.app",
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: "l-11-12", title: "Hangman: Python Syntax Slayer", type: "game-based-learning", duration: "20m", completed: false, locked: false,
            gameType: "hangman",
            gameUrl: "https://hangman-timespro.lovable.app",
...
export const studentCertificates: StudentCertificate[] = [
  ...
  { id: "c-3", title: "Linux Fundamentals", issuer: "TechSkills Academy", issuedDate: "Jan 5, 2025", expiryDate: "Jan 5, 2027", credentialId: "LF-2025-00089", status: "issued", progress: 100, skills: ["Linux", "CLI", "Shell Scripting", "System Admin"], description: "Certified Linux Fundamentals — valid for 2 years.", recipient: "Alex Student", verifyUrl: "https://verify.platform.io/LF-2025-00089" },
