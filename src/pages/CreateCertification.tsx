...
import { ArrowLeft, Award, Plus, X, Palette } from "lucide-react";
...
const CreateCertification = () => {
  ...
  const handleSubmit = (asDraft: boolean) => {
    ...
    toast({
      title: "Success",
      description: `Certification "${certification.name}" created successfully`,
    });
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Design a new certification template"
        breadcrumbs={[
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the certification details</CardDescription>
            </CardHeader>
