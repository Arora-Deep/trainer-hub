...
const initialBatches: Batch[] = [
  ...
  // ───────── DEMO BATCHES ─────────
  {
    ...
    vmConfig: {
      id: "vm-10",
      dateRange: { from: "2026-06-01", to: "2026-06-28" },
      vmEntries: [],
      vmType: "single",
      vmTemplates: [{ templateId: "tpl-1", instanceName: "Java Dev Sandbox" }],
      trainerVM: {
        status: "configured",
      ...
      snapshots: [
        { id: "snap-10-1", name: "Golden — JDK 21 + Maven", description: "Base Java Dev Sandbox image with JDK 21, Maven, IntelliJ CE and starter projects.", createdAt: "2026-05-29T10:00:00Z", size: "4.8 GB", status: "ready", isGolden: true },
        { id: "snap-10-2", name: "Post Chapter 2", description: "Snapshot after FizzBuzz lab", createdAt: "2026-06-03T15:00:00Z", size: "5.2 GB", status: "ready", isGolden: false },
        { id: "snap-10-3", name: "Post OOP Lab", description: "After Library Management starter loaded", createdAt: "2026-06-06T11:00:00Z", size: "5.6 GB", status: "ready", isGolden: false },
      ],
      goldenSnapshotId: "snap-10-1",
      participantVMs: [
        { id: "jv-vm-1",  assignedTo: "Aarav Sharma",  assignedEmail: "aarav.sharma@demo.in",  vmName: "java-dev-aarav",  status: "running", ipAddress: "10.0.10.11", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-2",  assignedTo: "Ishita Verma",  assignedEmail: "ishita.verma@demo.in",  vmName: "java-dev-ishita", status: "running", ipAddress: "10.0.10.12", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-3",  assignedTo: "Rohan Mehta",   assignedEmail: "rohan.mehta@demo.in",   vmName: "java-dev-rohan",  status: "running", ipAddress: "10.0.10.13", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-2" },
        { id: "jv-vm-4",  assignedTo: "Sneha Iyer",    assignedEmail: "sneha.iyer@demo.in",    vmName: "java-dev-sneha",  status: "running", ipAddress: "10.0.10.14", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-5",  assignedTo: "Vikram Singh",  assignedEmail: "vikram.singh@demo.in",  vmName: "java-dev-vikram", status: "stopped", ipAddress: "10.0.10.15", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-1" },
        { id: "jv-vm-6",  assignedTo: "Priya Nair",    assignedEmail: "priya.nair@demo.in",    vmName: "java-dev-priya",  status: "running", ipAddress: "10.0.10.16", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-7",  assignedTo: "Karan Patel",   assignedEmail: "karan.patel@demo.in",   vmName: "java-dev-karan",  status: "running", ipAddress: "10.0.10.17", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-2" },
        { id: "jv-vm-8",  assignedTo: "Ananya Rao",    assignedEmail: "ananya.rao@demo.in",    vmName: "java-dev-ananya", status: "running", ipAddress: "10.0.10.18", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-9",  assignedTo: "Dev Khanna",    assignedEmail: "dev.khanna@demo.in",    vmName: "java-dev-dev",    status: "stopped", ipAddress: "10.0.10.19", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-1" },
        { id: "jv-vm-10", assignedTo: "Meera Joshi",   assignedEmail: "meera.joshi@demo.in",   vmName: "java-dev-meera",  status: "running", ipAddress: "10.0.10.20", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-11", assignedTo: "Arjun Kapoor",  assignedEmail: "arjun.kapoor@demo.in",  vmName: "java-dev-arjun",  status: "running", ipAddress: "10.0.10.21", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-2" },
        { id: "jv-vm-12", assignedTo: "Nisha Reddy",   assignedEmail: "nisha.reddy@demo.in",   vmName: "java-dev-nisha",  status: "running", ipAddress: "10.0.10.22", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-13", assignedTo: "Yash Malhotra", assignedEmail: "yash.malhotra@demo.in", vmName: "java-dev-yash",   status: "error",   ipAddress: "10.0.10.23", startedAt: "2026-06-01T09:00:00Z" },
        { id: "jv-vm-14", assignedTo: "Riya Bansal",   assignedEmail: "riya.bansal@demo.in",   vmName: "java-dev-riya",   status: "running", ipAddress: "10.0.10.24", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-3" },
        { id: "jv-vm-15", assignedTo: "Sahil Chawla",  assignedEmail: "sahil.chawla@demo.in",  vmName: "java-dev-sahil",  status: "running", ipAddress: "10.0.10.25", startedAt: "2026-06-01T09:00:00Z", currentSnapshotId: "snap-10-2" },
      ],
      cloneStatus: "cloned",
